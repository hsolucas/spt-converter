...
public class SptConverter {
    ...
    static String OUTPUT_FILE_PATH = "files/output/new_geofile2.json";
    ...
    public static void writeGeoJson(Map<String,Trip> trips){
        ...
        try(FileWriter writer = new FileWriter(OUTPUT_FILE_PATH, false)){
            ...
            for(Trip t : trips.values()){
                ...
                writer.write("\t\t\t\"EMPRESA1\" : \"" + (t.getBilhetagem().getEmpresa() != null ? t.getBilhetagem().getEmpresa() : t.getDadosMapa().getEMPRESA1()) + "\",\n");
    ...
    private static String calcPct(int part, int total){
        //System.out.println("CALC PCT " + part + " " + total);
        try{
    ...
    public static Map<String, Trip> readAllTrips(){
        List<String> trips = readFileContent("files/sptrans-gtfs/trips.txt", MAX_READS);
